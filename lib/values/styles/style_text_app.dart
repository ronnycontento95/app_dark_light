...
TextStyle get _styleDmSans400 => _styleIbmPlexSans(FontWeight.w400);
TextStyle get _styleDmSans700 => _styleIbmPlexSans(FontWeight.w700);
...
TextStyle get _styleCation =>
    TextStyle(fontSize: sizeTextCaption).merge(_styleDmSans400);

TextStyle get _styleOverLine =>
    TextStyle(fontSize: sizeTextOverLine).merge(_styleDmSans700);
